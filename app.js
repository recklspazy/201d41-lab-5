...
16 " The multiplication of 4 and 7 is 28." "4 and 7 and 5 sums to 16" " The product of 4 and 7 and 5 is undefined"
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  return [ multiply(multiply(multiply(multiply(testDynamicArray [0], testDynamicArray [1])[0], testDynamicArray [2])[0], testDynamicArray [3])[0],testDynamicArray[4])[0], 'The numbers ' + testDynamicArray.toString() + ' have a product of ' + 
  multiply(multiply(multiply(multiply(testDynamicArray [0], testDynamicArray [1])[0], testDynamicArray [2])[0], testDynamicArray [3])[0],testDynamicArray[4])[0] + '.'];
